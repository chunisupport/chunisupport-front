    ...
    <div class="min-h-screen flex justify-center px-4 py-10">
      <div class="w-full max-w-md">
        ...
        <div class="mb-6 text-center">
          <TextField>
            <TextField.Input
              class="mb-2 w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
              placeholder="ユーザー名"
              value={username()}
        ...
        <div class="text-center">
          <p class="mb-3 text-sm text-gray-600">
            パスワードを忘れた場合は
            <A href="/recovery" class="text-green-500 underline ml-1">
              こちら
            </A>
          </p>
          <p class="mb-5 text-sm text-gray-600">
            新規アカウント作成は
            <A href="/register" class="text-green-500 underline ml-1">
              こちら
            </A>
          </p>
