...
import { resetPasswordWithRecoveryCode } from '../../api/settings'
import { useDocumentTitle } from '../../hooks/useDocumentTitle'

const SettingsRecoveryResetPage = () => {
  ...
  return (
    <div class="mx-auto w-full max-w-2xl p-6">
      ...
      <p class="mt-2 text-sm text-gray-600">
        この操作は未ログイン状態でも利用できます。コードは{' '}
        <span class="font-mono">XXXX-XXXX-XXXX</span> 形式です。
      </p>
...
export default SettingsRecoveryResetPage
