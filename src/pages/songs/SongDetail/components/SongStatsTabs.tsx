          ...
          <For each={props.difficulties}>
            {(difficulty) => (
              <Tabs.Trigger
                ...
                class="rounded border border-gray-300 bg-white px-3 py-1 text-sm text-gray-700 data-selected:border-green-600 data-selected:bg-green-50 data-selected:text-green-700"
              >
                {difficulty.label}
              </Tabs.Trigger>
            )}
