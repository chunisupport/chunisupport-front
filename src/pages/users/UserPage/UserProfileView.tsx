...
import {
  ...
  type WorldsendSortDirection,
  type WorldsendSortKey,
} from './worldsendRecords'
...
const WorldsendRecordTable: Component<{ records: WorldsendRecordDTO[] }> = (props) => {
  const [sortKey, setSortKey] = createSignal<WorldsendSortKey | null>(null)
  const [sortDirection, setSortDirection] = createSignal<WorldsendSortDirection | null>(null)

  const sortedRecords = createMemo(() =>
    sortWorldsendRecords(props.records, sortKey(), sortDirection())
  )
