...
> = {
  ...
  const: { id: 'const', label: '定数', width: '3.1rem', sortKey: 'const' },
  score: { id: 'score', label: 'スコア', width: '3.8rem', sortKey: 'score' },
  rating: { id: 'rating', label: 'レート', width: '3.6rem', sortKey: 'rating' },
  lamp: { id: 'lamp', label: 'AJ', width: '3rem', sortKey: 'lamp' },
