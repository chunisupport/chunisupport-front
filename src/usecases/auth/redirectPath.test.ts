...
test('buildLoginRedirectPath: register-scoreのtokenクエリを保持する', () => {
  const result = buildLoginRedirectPath(
    '/register-score?token=ad7ed422-de43-4fae-ac19-bf62323deb3a'
  )
  assert.equal(
    result,
    '/login?redirect=%2Fregister-score%3Ftoken%3Dad7ed422-de43-4fae-ac19-bf62323deb3a'
  )
})
